...
def apresenteSe ():
    ...
    print('|                                                             |')
    print('| RA: 23325/ Nome: Lucas Proença Barros Siqueira              |')
    print('|                                                             |')
...
def connectar() -> bool:
    ...
    try:
        ...
        connection = pyodbc.connect(
            ...
            database = "BD23325", #banco de dados
            uid = "BD23325", #LOGIN
            pwd = "BD23325" #SENHA
        ) # xxxxx é seu RA
        return True
...
def atualizar ():
    ...
    while opcao!=6:
        ...
        if opcao == 1:
            dados_selecionados[0][2] = input('Aniversário: ')
        elif opcao == 2:
            dados_selecionados[0][3] = input('Endereco: ')
        elif opcao == 3:
            dados_selecionados[0][4] = input('Telefone: ')
        elif opcao == 4:
            dados_selecionados[0][5] = input('Celular: ')
        elif opcao == 5:
            dados_selecionados[0][6] = input('e-mail: ')
        elif opcao ==6:
            print("Atualizações finalizadas!")
        
    print('\nAniversario:',dados_selecionados[0][2])
    print('Endereco...:',dados_selecionados[0][3])
    print('Telefone...:',dados_selecionados[0][4])
    print('Celular....:',dados_selecionados[0][5])
    print('e-mail.....:',dados_selecionados[0][6])
